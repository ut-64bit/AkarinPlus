...
scoreboard objectives add AkarinPlus.Setting dummy
scoreboard objectives add AkarinPlus.Temporary dummy
...
scoreboard objectives add AkarinPlus.Use.Bow minecraft.used:minecraft.bow
...
scoreboard players set $HomingArrow.Speed AkarinPlus.Setting 3