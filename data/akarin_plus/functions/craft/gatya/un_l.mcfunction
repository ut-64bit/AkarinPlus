#> akarin_plus:craft/gatya/un_l
# @within advancement akarin_plus:craft/gatya/un_l
...
recipe take @s akarin_plus:craft/gatya/un_l
advancement revoke @s only akarin_plus:craft/gatya/un_l