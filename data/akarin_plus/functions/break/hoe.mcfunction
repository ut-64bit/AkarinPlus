#> akarin_plus:break/hoe
# @within advancement akarin_plus:break/hoe
...
execute if score $grade AkarinPlus.Temporary matches 3 run item replace entity @s weapon.mainhand with stone_hoe 1
execute if score $grade AkarinPlus.Temporary matches 6 run item replace entity @s weapon.mainhand with golden_hoe 1
execute if score $grade AkarinPlus.Temporary matches 9 run item replace entity @s weapon.mainhand with iron_hoe 1
execute if score $grade AkarinPlus.Temporary matches 12 run item replace entity @s weapon.mainhand with diamond_hoe 1
execute if score $grade AkarinPlus.Temporary matches 15 run item replace entity @s weapon.mainhand with netherite_hoe 1
...
advancement revoke @s only akarin_plus:break/hoe