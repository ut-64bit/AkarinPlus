...
execute if score $grade AkarinPlus.Temp matches 3 run item replace entity @s weapon.mainhand with stone_hoe 1
execute if score $grade AkarinPlus.Temp matches 6 run item replace entity @s weapon.mainhand with golden_hoe 1
execute if score $grade AkarinPlus.Temp matches 9 run item replace entity @s weapon.mainhand with iron_hoe 1
execute if score $grade AkarinPlus.Temp matches 12 run item replace entity @s weapon.mainhand with diamond_hoe 1
execute if score $grade AkarinPlus.Temp matches 15 run item replace entity @s weapon.mainhand with netherite_hoe 1
