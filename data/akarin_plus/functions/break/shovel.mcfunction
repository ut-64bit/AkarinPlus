...
execute if score $grade AkarinPlus.Temporary matches 3 run item replace entity @s weapon.mainhand with stone_shovel 1
execute if score $grade AkarinPlus.Temporary matches 6 run item replace entity @s weapon.mainhand with golden_shovel 1
execute if score $grade AkarinPlus.Temporary matches 9 run item replace entity @s weapon.mainhand with iron_shovel 1
execute if score $grade AkarinPlus.Temporary matches 12 run item replace entity @s weapon.mainhand with diamond_shovel 1
execute if score $grade AkarinPlus.Temporary matches 15 run item replace entity @s weapon.mainhand with netherite_shovel 1
