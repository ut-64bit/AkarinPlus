...
execute store result score $fortune AkarinPlus.Temp run data get storage _index.d Item.Enchantments[{id:"minecraft:fortune"}].lvl 1.0
scoreboard players add $fortune AkarinPlus.Temp 1
execute store result storage _index.d Item.Enchantments[{id:"minecraft:fortune"}].lvl short 1.0 run scoreboard players get $fortune AkarinPlus.Temp
