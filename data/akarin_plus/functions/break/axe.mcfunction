...
execute if score $grade AkarinPlus.Temporary matches 3 run item replace entity @s weapon.mainhand with stone_axe 1
execute if score $grade AkarinPlus.Temporary matches 6 run item replace entity @s weapon.mainhand with golden_axe 1
execute if score $grade AkarinPlus.Temporary matches 9 run item replace entity @s weapon.mainhand with iron_axe 1
execute if score $grade AkarinPlus.Temporary matches 12 run item replace entity @s weapon.mainhand with diamond_axe 1
execute if score $grade AkarinPlus.Temporary matches 15 run item replace entity @s weapon.mainhand with netherite_axe 1
