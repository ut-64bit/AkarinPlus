...
# Uncommon
    ## Uncommon
        loot give @s loot akarin_plus:items/uncommon/potion
        loot give @s loot akarin_plus:items/uncommon/nise-insanity

    ## Uncommon+
        loot give @s loot akarin_plus:items/uncommon/hight_potion

    ## Uncommon++
        loot give @s loot akarin_plus:items/uncommon/elixier
...
# Legend
    ...
    ## Legend++
        ...
        loot give @s loot akarin_plus:items/legend/amulets/health_amulet
